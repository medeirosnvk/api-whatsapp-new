...
exports.ExposeLegacyStore = () => {
  ...
  window.Store.getMsgInfo =
    (window.mR.findModule("sendQueryMsgInfo")[0] || {}).sendQueryMsgInfo || window.mR.findModule("queryMsgInfo")[0].queryMsgInfo;
  ...
  window.injectToFunction = (target, callback) => {
    const module = typeof target.module === "string" ? window.mR.findModule(target.module) : window.mR.modules[target.module];
